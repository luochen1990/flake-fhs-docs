...
<FileTree>
- pkgs/
  - weather/             <Badge text="子目录包 (推荐)" variant="default" size="small" />
    - package.nix        <Badge text="入口文件" variant="default" size="small" />
    - helper.nix         <Badge text="辅助文件 (不会被扫描为独立包)" variant="default" size="small" />
...
`pkgs/editorconfig-core-c/package.nix`:
